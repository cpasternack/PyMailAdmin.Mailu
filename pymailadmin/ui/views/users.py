...
from pymailadmin.ui import ui, access, forms
...
def user_signup(domain_name=None):
  ...
  quota_bytes = domain.max_quota_bytes or app.configMail['MAIL_DEFAULT_QUOTA']
  if app.configApp['APP_RECAPTCHA_PUBLIC_KEY'] == "" or app.configApp['APP_RECAPTCHA_PRIVATE_KEY'] == "":
