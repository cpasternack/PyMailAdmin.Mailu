...
from pymailadmin.internal import internal
...
def dovecot_passdb_dict(user_email):
  ...
  allow_nets = []
  allow_nets.append(app.configMail["MAIL_SUBNET"])
  if app.configMail["MAIL_SUBNET6"]:
    allow_nets.append(app.configMail["MAIL_SUBNET6"])
